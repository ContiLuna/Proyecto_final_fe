                ...
                <div className="row ">
                    ...
                    <div className="col-md-4 col-sm-4">
                        ...
                        <ul className='list-unstyled d-flex justify-content-between m-4'>
                            <a href="https://facebook.com" target='_blank' role="button" className="btn btn-primary text-center"><i className="bi bi-facebook"></i></a>
                            <a href="https://instagram.com" target='_blank' role="button" className="btn btn-danger text-center"><i className="bi bi-instagram"></i></a>
                            <a href="https://twitter.com" target='_blank' role="button" className="btn btn-primary text-center"><i className="bi bi-twitter"></i></a>
                        </ul>
                    </div>
                </div>
